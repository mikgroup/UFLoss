...
class ArrayToBlocks(nn.Module):
    ...
    def extract(self, images):
        ...
        images = images.reshape([1, self.nx, self.ny, self.nt * self.ne * 2]).permute(
            0, 3, 2, 1
        )
    ...
    def combine(self, blocks):
        ...
        images = center_crop(
            images.permute(0, 3, 2, 1), [1, self.nx, self.ny, self.nt * self.ne * 2]
        )
