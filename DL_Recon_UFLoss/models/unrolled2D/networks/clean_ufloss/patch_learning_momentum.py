...
def get_args():
    ...
    parser.add_option('--datadir', "--dd",
                      help='Directory contains 2D patches.')
    ...
    parser.add_option('--use_phase_augmentation', action="store_true", default=False,
...
class Trainer:
    ...
    def __init__(self):
        ...
        self.dataloader = DataLoader(self.dataset, self.args.batchsize, shuffle=True, drop_last=True,num_workers=0)

        self.data_length = len(self.dataset)
        self.model = Model(resnet18, temperature=self.args.temperature,
                                   device=self.device,data_length=self.data_length)
