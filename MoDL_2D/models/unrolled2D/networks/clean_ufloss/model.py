...
class Model(torch.nn.Module):
    ...
    def __init__(self, network_class, feature_dim=128,
                 temperature=1.0, device=torch.device('cpu'), data_length=921600):
        super().__init__()
        ...
        self.register_buffer("memory_bank", torch.randn(feature_dim, self.data_length))  # Save memory bank with model
