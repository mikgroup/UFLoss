...
ufloss_weight=15
uflossfreq=16
checkpoint=/mikQNAP/NYU_knee_data/knee_train_h5/checkpoints/summary/train-3D_MELD_4steps_MoDLflag0_CGsteps_6date_20210405_ufloss0_ufloss_weight_15/model_epoch13.pt
# convtype='conv2p1d'
# Name of model
